...
use crate::{
    ...
    error::*,
    http_requests::{
        back, close_active_tab, execute_script_sync, find_element, forward, get_active_tab_title,
        get_active_tab_url, get_all_cookies, get_page_source, get_selected_tab, navigate, refresh,
        select_tab, set_cookie, CookieData,
    },
    session::*,
};
